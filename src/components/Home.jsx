...
import reader from '../assets/work-hard.json'
import { ShoppingCartIcon } from '@heroicons/react/24/solid'
import { Link } from 'react-router-dom'

const Home = () => {
    return (
        <div className='my-home flex flex-col items-center justify-between lg:flex-row'>
            {/* Text Content */}
            <div className='mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0'>
                ...
                <div className='flex flex-col items-center md:flex-row'>
                    <Link to='/books' className='btn hover:bg-red-300 md:w-auto md:mr-4'>
